...
<head>
	<php? ?>
		<title><?= $video_result['title'] ?> - BLOG NCOV Developed By Group Thiện và 4 con vợ</title>
		<?php ?>
		...
		<meta property="og:title" content="<?= $video_result['title'] ?> - BLOG NCOV Developed By Group Thiện và 4 con vợ">
